...
polygon_calculations.o: src/polygon_calculations.cpp
...
main: main.o circle.o triangle.o polygon.o circle_calculations.o triangle_calculations.o polygon_calculations.o print.o
